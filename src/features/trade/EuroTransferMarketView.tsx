...
import { buildNBATargetPoolForAI } from '../team/EuroNBAVeteranPool';
import type { NBAEuroProspect } from '../league/NBAEuroPoolModule';
import { PageHeader } from '../ui/PageHeader';

// The following duplicate functions have been removed in favor of the shared EuroNBAVeteranPool.ts module
// to ensure consistency between the AI and the Player's Market.
const buildNBATargetPool = (gameYear: number): NBAEuroProspect[] => {
    return buildNBATargetPoolForAI(gameYear);
};
