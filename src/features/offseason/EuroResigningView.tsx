        ...
        <div style={{ 
            ...
            <div style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
                <div style={{ marginBottom: '30px' }}>
                    {/* Budget Section */}
                    <div style={{ background: 'var(--bg-card)', padding: '20px 30px', borderRadius: '28px', border: '1px solid var(--border-color)', display: 'inline-flex', flexDirection: 'column', justifyContent: 'center', boxShadow: 'var(--shadow-sm)' }}>
                        <div style={{ fontSize: '0.75rem', color: 'var(--text-dim)', fontWeight: 800, textTransform: 'uppercase', marginBottom: '4px', letterSpacing: '1px' }}>BUDGET LEFT</div>
                        ...
                        return (
                            ...
                            >
                                <div style={{ padding: '16px' }}>
                                    ...
                                    {/* Last Season Stats */}
                                    <div style={{ background: ovr >= 85 ? 'rgba(0,0,0,0.05)' : 'rgba(255,255,255,0.03)', borderRadius: '16px', padding: '12px', marginBottom: '16px', border: ovr >= 85 ? '1px solid rgba(0,0,0,0.1)' : '1px solid var(--bg-card-hover)' }}>
