...
export const ResigningView: React.FC<ResigningViewProps> = ({ onSelectPlayer, onShowMessage }) => {
    ...
    return (
        <div style={{ padding: '20px', maxWidth: '1000px', margin: '0 auto', color: 'var(--text)', paddingBottom: '100px' }}>
            {/* Header - Always Visible unless mobile detail view? Maybe keep small header */}
            {(!isMobile || !negotiatingPlayer) && (
                <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px', gap: '20px' }}>
                    <div>
                        ...
                        <p style={{ margin: '5px 0 0 0', color: 'var(--text-secondary)' }}>
                            Negotiate with expiring contracts.
                        </p>
                        <div style={{ display: 'flex', gap: '20px', marginTop: '10px' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', background: 'var(--surface)', padding: '6px 14px', borderRadius: '12px', border: '1px solid var(--border)' }}>
                                ...
                                <span style={{ fontSize: '0.85rem', color: 'var(--text-secondary)' }}>Cash:</span>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', background: 'var(--surface)', padding: '6px 14px', borderRadius: '12px', border: '1px solid var(--border)' }}>
                                ...
                                <span style={{ fontSize: '0.85rem', color: 'var(--text-secondary)' }}>Space:</span>
            ...
            <div style={{
                ...
                {/* Negotiation Column */}
                {(!isMobile || negotiatingPlayer) && (
                    <div className={isMobile ? "animate-enter" : ""}>
                        {isMobile && negotiatingPlayer && (
                            <button
                                onClick={() => setNegotiatingPlayer(null)}
                                style={{ marginBottom: '15px', color: 'var(--text-secondary)', display: 'flex', alignItems: 'center', gap: '5px' }}
                            >
                                ← Back to List
                            </button>
                        )}
