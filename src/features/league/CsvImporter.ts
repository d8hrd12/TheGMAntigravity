        ...
        parsedPlayers.forEach(row => {
            ...
            const player: Player = {
                ...
                seasonStats: {
                    ...
                    rebounds: parseFloat(row.total_rebounds) || 0,
                    assists: parseFloat(row.assists) || 0,
                    steals: parseFloat(row.steals) || 0,
                    blocks: parseFloat(row.blocks) || 0,
                    turnovers: parseFloat(row.turnovers) || 0,
                    fouls: parseFloat(row.personal_fouls) || 0,
                    offensiveRebounds: parseFloat(row.offensive_rebounds) || 0,
                    defensiveRebounds: parseFloat(row.defensive_rebounds) || 0,
                    fgMade: parseFloat(row.field_goals) || 0,
                    fgAttempted: parseFloat(row.field_goals_attempted) || 0,
                    threeMade: parseFloat(row.three_pointers) || 0,
                    threeAttempted: parseFloat(row.three_pointers_attempted) || 0,
                    ftMade: parseFloat(row.free_throws) || 0,
                    ftAttempted: parseFloat(row.free_throws_attempted) || 0,
                    plusMinus: 0,
