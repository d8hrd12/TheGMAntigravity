...
export const TeamSelectionView: React.FC<TeamSelectionViewProps> = ({ onSelectTeam }) => {
    ...
    return (
        <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '20px', textAlign: 'center', background: '#f5f5f5', minHeight: '100vh' }}>
            ...
            <p style={{ marginBottom: '30px', color: '#666' }}>Choose the franchise you want to lead to glory.</p>
