...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        MotionEvent velocityTrackerMotionEvent = MotionEvent.obtain(motionEvent2);
        ...
        switch (actionMasked) {
            ...
            case 1:
                ...
                break;
            case 2:
                int activePointerIndex = motionEvent2.findPointerIndex(this.mActivePointerId);
                if (activePointerIndex != -1) {
                    int y = (int) motionEvent2.getY(activePointerIndex);
                    int deltaY = this.mLastMotionY - y;
                    int deltaY2 = deltaY - releaseVerticalGlow(deltaY, motionEvent2.getX(activePointerIndex));
                    ...
                    if (this.mIsBeingDragged) {
                        int scrollOffset = scrollBy(deltaY2, 1, motionEvent2, (int) motionEvent2.getX(activePointerIndex), 0, false);
            ...
            case 3:
                ...
                break;
            case 5:
                int index = motionEvent2.getActionIndex();
                this.mLastMotionY = (int) motionEvent2.getY(index);
                this.mActivePointerId = motionEvent2.getPointerId(index);
                break;
            case 6:
    ...
    private int scrollBy(int verticalScrollDistance, int x, int touchType, boolean isSourceMouseOrKeyboard) {
        return scrollBy(verticalScrollDistance, -1, (MotionEvent) null, x, touchType, isSourceMouseOrKeyboard);
    }

    /* access modifiers changed from: package-private */
    public int scrollBy(int verticalScrollDistance, int verticalScrollAxis, MotionEvent ev, int x, int touchType, boolean isSourceMouseOrKeyboard) {
        int totalScrollOffset;
        int verticalScrollDistance2;
        int i = verticalScrollAxis;
        int i2 = x;
        int i3 = touchType;
        if (i3 == 1) {
        ...
        int i4 = i3;
        if (dispatchNestedPreScroll(0, verticalScrollDistance, this.mScrollConsumed, this.mScrollOffset, i3)) {
        ...
        boolean hitScrollBarrier = overScrollByCompat(0, verticalScrollDistance2, 0, initialScrollY, 0, scrollRangeY, 0, 0, true) && !hasNestedScrollingParent(i4);
        int scrollYDelta = getScrollY() - initialScrollY2;
        if (!(ev == null || scrollYDelta == 0)) {
            getScrollFeedbackProvider().onScrollProgress(ev.getDeviceId(), ev.getSource(), i, scrollYDelta);
        }
        this.mScrollConsumed[1] = 0;
        int i5 = i4;
        dispatchNestedScroll(0, scrollYDelta, 0, verticalScrollDistance3 - scrollYDelta, this.mScrollOffset, i5, this.mScrollConsumed);
        int i6 = i5;
        ...
        if (newScrollY < 0) {
            if (canOverscroll) {
                EdgeEffectCompat.onPullDistance(this.mEdgeGlowTop, ((float) (-verticalScrollDistance4)) / ((float) getHeight()), ((float) i2) / ((float) getWidth()));
                if (ev != null) {
                    getScrollFeedbackProvider().onScrollLimit(ev.getDeviceId(), ev.getSource(), i, true);
                }
            ...
            EdgeEffectCompat.onPullDistance(this.mEdgeGlowBottom, ((float) verticalScrollDistance4) / ((float) getHeight()), 1.0f - (((float) i2) / ((float) getWidth())));
            if (ev != null) {
                getScrollFeedbackProvider().onScrollLimit(ev.getDeviceId(), ev.getSource(), i, false);
            }
        ...
        if (hitScrollBarrier && i6 == 0 && this.mVelocityTracker != null) {
            this.mVelocityTracker.clear();
        }
        if (i6 == 1) {
            stopNestedScroll(i6);
    ...
    public boolean onGenericMotionEvent(MotionEvent motionEvent) {
        ...
        if (verticalScroll != 0.0f) {
            ...
            scrollBy(-((int) (getVerticalScrollFactorCompat() * verticalScroll)), axis, motionEvent3, x, 1, MotionEventCompat.isFromSource(motionEvent, 8194));
            if (axis == 0) {
                return true;
            }
            this.mDifferentialMotionFlingController.onMotionEvent(motionEvent3, axis);
            return true;
        }
