...
public final class TreeIterator<T> implements Iterator<T>, KMappedMarker {
    ...
    public TreeIterator(Iterator<? extends T> rootIterator, Function1<? super T, ? extends Iterator<? extends T>> getChildIterator2) {
        this.getChildIterator = getChildIterator2;
        this.iterator = rootIterator;
    }
    ...
    private final void prepareNextIterator(T item) {
        Iterator childIterator = this.getChildIterator.invoke(item);
