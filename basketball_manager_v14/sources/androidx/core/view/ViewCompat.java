...
public class ViewCompat {
    ...
    public static void setOnReceiveContentListener(View view, String[] mimeTypes, OnReceiveContentListener listener) {
        ...
        if (mimeTypes2 != null) {
            ...
            while (true) {
                if (i >= length) {
                    break;
                } else if (mimeTypes2[i].startsWith(ProxyConfig.MATCH_ALL_SCHEMES)) {
    ...
    static void fallbackTransformMatrixToGlobal(View view, Matrix matrix) {
        ...
        if (parent instanceof View) {
            ...
            matrix.preTranslate((float) (-parentView.getScrollX()), (float) (-parentView.getScrollY()));
        }
    ...
    private static class Api21Impl {
        ...
        static void setOnApplyWindowInsetsListener(final View v, final OnApplyWindowInsetsListener listener) {
            View.OnApplyWindowInsetsListener wrappedUserListener = listener != null ? new View.OnApplyWindowInsetsListener() {
