...
final class AconfigPackageCompatApi36Impl implements AconfigPackageCompat {
    ...
    public AconfigPackageCompatApi36Impl(AconfigPackage aconfigPackageImpl2) {
        Intrinsics.checkNotNullParameter(aconfigPackageImpl2, "aconfigPackageImpl");
        this.aconfigPackageImpl = aconfigPackageImpl2;
    }
