...
public final class MaskedDrawable extends Drawable {
    ...
    public MaskedDrawable(Drawable drawable2, float maskDiameter2) {
        Intrinsics.checkNotNullParameter(drawable2, "drawable");
        this.drawable = drawable2;
        this.maskDiameter = maskDiameter2;
        Path $this$mask_u24lambda_u240 = new Path();
        $this$mask_u24lambda_u240.addCircle(0.0f, 0.0f, this.maskDiameter / 2.0f, Path.Direction.CW);
