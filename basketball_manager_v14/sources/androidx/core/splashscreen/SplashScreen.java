...
public final class SplashScreen {
    ...
    private static class Impl {
        ...
        public void setKeepOnScreenCondition(KeepOnScreenCondition keepOnScreenCondition) {
            ...
            this.splashScreenWaitPredicate = keepOnScreenCondition;
            View contentView = this.activity.findViewById(16908290);
            contentView.getViewTreeObserver().addOnPreDrawListener(new SplashScreen$Impl$setKeepOnScreenCondition$1(this, contentView));
        }
        ...
        public void setOnExitAnimationListener(OnExitAnimationListener exitAnimationListener) {
            ...
            splashScreenView.addOnLayoutChangeListener(new SplashScreen$Impl$setOnExitAnimationListener$2(this, splashScreenViewProvider));
        }

        private final void displaySplashScreenIcon(View splashScreenView, Drawable icon2) {
            float maskSize;
            ImageView $this$displaySplashScreenIcon_u24lambda_u242 = (ImageView) splashScreenView.findViewById(R.id.splashscreen_icon_view);
            if (this.hasBackground) {
                Drawable iconBackgroundDrawable = AppCompatResources.getDrawable($this$displaySplashScreenIcon_u24lambda_u242.getContext(), R.drawable.icon_background);
                maskSize = SplashScreen.MASK_FACTOR * $this$displaySplashScreenIcon_u24lambda_u242.getResources().getDimension(R.dimen.splashscreen_icon_size_with_background);
                if (iconBackgroundDrawable != null) {
                    $this$displaySplashScreenIcon_u24lambda_u242.setBackground(new MaskedDrawable(iconBackgroundDrawable, maskSize));
                }
            } else {
                maskSize = SplashScreen.MASK_FACTOR * $this$displaySplashScreenIcon_u24lambda_u242.getResources().getDimension(R.dimen.splashscreen_icon_size_no_background);
            }
            $this$displaySplashScreenIcon_u24lambda_u242.setImageDrawable(new MaskedDrawable(icon2, maskSize));
        }

        public final void dispatchOnExitAnimation(SplashScreenViewProvider splashScreenViewProvider) {
            Intrinsics.checkNotNullParameter(splashScreenViewProvider, "splashScreenViewProvider");
            OnExitAnimationListener finalListener = this.animationListener;
            if (finalListener != null) {
                this.animationListener = null;
                splashScreenViewProvider.getView().postOnAnimation(new SplashScreen$Impl$$ExternalSyntheticLambda1(splashScreenViewProvider, finalListener));
            }
        }
    ...
    private static final class Impl31 extends Impl {
        ...
        public void setKeepOnScreenCondition(KeepOnScreenCondition keepOnScreenCondition) {
            ...
            View contentView = getActivity().findViewById(16908290);
            ...
            this.preDrawListener = new SplashScreen$Impl31$setKeepOnScreenCondition$1(this, contentView);
            observer.addOnPreDrawListener(this.preDrawListener);
        }

        public void setOnExitAnimationListener(OnExitAnimationListener exitAnimationListener) {
            Intrinsics.checkNotNullParameter(exitAnimationListener, "exitAnimationListener");
            getActivity().getSplashScreen().setOnExitAnimationListener(new SplashScreen$Impl31$$ExternalSyntheticLambda0(this, exitAnimationListener));
        }
        ...
        private final void applyAppSystemUiTheme() {
            ...
            decorView2.setOnHierarchyChangeListener((ViewGroup.OnHierarchyChangeListener) null);
