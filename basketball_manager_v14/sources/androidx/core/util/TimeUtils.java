...
public final class TimeUtils {
    ...
    private static int formatDurationLocked(long duration, int fieldLen) {
        ...
        int days2 = days;
        int start2 = start;
        int pos4 = printField(formatStr, days2, 'd', pos2, false, 0);
        int i2 = days2;
        int pos5 = printField(formatStr, hours, 'h', pos4, pos4 != start2, zeropad ? 2 : 0);
        int pos6 = printField(formatStr, minutes, 'm', pos5, pos5 != start2, zeropad ? 2 : 0);
        int pos7 = printField(formatStr, seconds, 's', pos6, pos6 != start2, zeropad ? 2 : 0);
        int pos8 = printField(formatStr, millis, 'm', pos7, true, (!zeropad || pos7 == start2) ? 0 : 3);
        formatStr[pos8] = 's';
        return pos8 + 1;
    }
