...
public class NotificationCompat {
    ...
    public static class ProgressStyle extends Style {
        ...
        public void restoreFromCompatExtras(Bundle extras) {
            super.restoreFromCompatExtras(extras);
            this.mProgressSegments = getProgressSegmentsFromBundleList(BundleCompat.getParcelableArrayList(extras, NotificationCompat.EXTRA_PROGRESS_SEGMENTS, Bundle.class));
            ...
            this.mProgressPoints = getProgressPointsFromBundleList(BundleCompat.getParcelableArrayList(extras, NotificationCompat.EXTRA_PROGRESS_POINTS, Bundle.class));
            this.mTrackerIcon = asIconCompat((Parcelable) BundleCompat.getParcelable(extras, NotificationCompat.EXTRA_PROGRESS_TRACKER_ICON, Icon.class));
            this.mStartIcon = asIconCompat((Parcelable) BundleCompat.getParcelable(extras, NotificationCompat.EXTRA_PROGRESS_START_ICON, Icon.class));
            this.mEndIcon = asIconCompat((Parcelable) BundleCompat.getParcelable(extras, NotificationCompat.EXTRA_PROGRESS_END_ICON, Icon.class));
        }
            ...
            if (segmentBundleList != null && !segmentBundleList.isEmpty()) {
                for (int i = 0; i < segmentBundleList.size(); i++) {
                    ...
                    if (length > 0) {
                        ...
                        segments.add(new Segment(length).setId(id).setColor(segmentBundle.getInt(KEY_ELEMENT_COLOR, 0)));
                    }
                }
            }
            return segments;
            ...
            if (pointBundleList != null && !pointBundleList.isEmpty()) {
                for (int i = 0; i < pointBundleList.size(); i++) {
                    ...
                    if (position >= 0) {
                        ...
                        points.add(new Point(position).setId(id).setColor(pointBundle.getInt(KEY_ELEMENT_COLOR, 0)));
                    }
                }
            }
            return points;
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        public static List<CharSequence> getTextsFromContentView(Context context, Notification notification) {
            ...
            try {
                ...
                View contentLayout = contentView.apply(packageContext, (ViewGroup) null);
