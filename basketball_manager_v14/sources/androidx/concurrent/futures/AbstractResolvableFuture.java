    ...
    public final V get(long timeout, TimeUnit unit) throws InterruptedException, TimeoutException, ExecutionException {
        ...
        if (!Thread.interrupted()) {
            ...
            if (remainingNanos + SPIN_THRESHOLD_NANOS < j) {
                ...
                long overWaitNanos2 = overWaitNanos - timeUnit.toNanos(timeoutNanos2);
                boolean shouldShowExtraNanos = (timeoutNanos2 == j || overWaitNanos2 > SPIN_THRESHOLD_NANOS) ? z : false;
                if (timeoutNanos2 > j) {
