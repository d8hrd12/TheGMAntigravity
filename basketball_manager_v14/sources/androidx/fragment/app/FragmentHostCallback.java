...
public abstract class FragmentHostCallback<H> extends FragmentContainer {
    ...
    public FragmentHostCallback(Activity activity2, Context context2, Handler handler2, int windowAnimations2) {
        Intrinsics.checkNotNullParameter(context2, "context");
        Intrinsics.checkNotNullParameter(handler2, "handler");
        this.activity = activity2;
        this.context = context2;
        this.handler = handler2;
        this.windowAnimations = windowAnimations2;
    ...
    public FragmentHostCallback(Context context2, Handler handler2, int windowAnimations2) {
        this(context2 instanceof Activity ? (Activity) context2 : null, context2, handler2, windowAnimations2);
        Intrinsics.checkNotNullParameter(context2, "context");
        Intrinsics.checkNotNullParameter(handler2, "handler");
    }

    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public FragmentHostCallback(FragmentActivity activity2) {
        this(activity2, activity2, new Handler(), 0);
    ...
    public void onStartIntentSenderFromFragment(Fragment fragment, IntentSender intent, int requestCode, Intent fillInIntent, int flagsMask, int flagsValues, int extraFlags, Bundle options) throws IntentSender.SendIntentException {
        ...
        if (requestCode == -1) {
            ...
            if (activity2 != null) {
                ActivityCompat.startIntentSenderForResult(activity2, intent, requestCode, fillInIntent, flagsMask, flagsValues, extraFlags, options);
                return;
            }
