...
public class FragmentController {
    ...
    public void restoreAllState(Parcelable state, List<Fragment> nonConfigList) {
        this.mHost.getFragmentManager().restoreAllState(state, new FragmentManagerNonConfig(nonConfigList, (Map<String, FragmentManagerNonConfig>) null, (Map<String, ViewModelStore>) null));
    }
