...
class FragmentStateManager {
    ...
    public void createView() {
        ...
        L_0x004c:
            ...
            goto L_0x00f0
        L_0x007b:
            androidx.fragment.app.Fragment r0 = r10.mFragment     // Catch:{ NotFoundException -> 0x008a }
            android.content.res.Resources r0 = r0.getResources()     // Catch:{ NotFoundException -> 0x008a }
            androidx.fragment.app.Fragment r2 = r10.mFragment     // Catch:{ NotFoundException -> 0x008a }
            int r2 = r2.mContainerId     // Catch:{ NotFoundException -> 0x008a }
            java.lang.String r0 = r0.getResourceName(r2)     // Catch:{ NotFoundException -> 0x008a }
            goto L_0x008e
        L_0x008a:
            r0 = move-exception
    ...
    public Bundle saveState() {
        ...
        if (this.mFragment.mState > 0) {
            ...
            Bundle childFragmentManagerState = this.mFragment.mChildFragmentManager.m85lambda$attachController$5$androidxfragmentappFragmentManager();
