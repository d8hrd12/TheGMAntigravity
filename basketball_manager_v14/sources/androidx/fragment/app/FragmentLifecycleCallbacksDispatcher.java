...
public final class FragmentLifecycleCallbacksDispatcher {
    ...
    private static final class FragmentLifecycleCallbacksHolder {
        ...
        public FragmentLifecycleCallbacksHolder(FragmentManager.FragmentLifecycleCallbacks callback2, boolean recursive2) {
            Intrinsics.checkNotNullParameter(callback2, PluginMethod.RETURN_CALLBACK);
    ...
    public final void unregisterFragmentLifecycleCallbacks(FragmentManager.FragmentLifecycleCallbacks cb) {
        ...
        synchronized (this.lifecycleCallbacks) {
            ...
            while (true) {
                if (i >= count) {
                    break;
                } else if (this.lifecycleCallbacks.get(i).getCallback() == cb) {
