...
public final class URLUtilCompat {
    ...
    public static String guessFileName(String url, String contentDisposition, String mimeType) {
        ...
        return filename2 + suggestExtensionFromMimeType(mimeType);
    }
    ...
    public static String getFilenameFromContentDisposition(String contentDisposition) {
        ...
        if (parts.length < 2 || "inline".equalsIgnoreCase(parts[0].trim())) {
            return null;
        }
        Matcher matcher = DISPOSITION_PATTERN.matcher(parts[1]);
    ...
    private static String parseExtValueString(String raw) {
        ...
        try {
            return URLDecoder.decode(encodePlusCharacters(parts[2], encoding), encoding);
