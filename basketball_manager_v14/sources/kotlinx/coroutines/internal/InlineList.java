...
public final class InlineList<E> {
    ...
    public static boolean m1672equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof InlineList) && Intrinsics.areEqual(obj, ((InlineList) obj2).m1678unboximpl());
    }
    ...
    public final /* synthetic */ Object m1678unboximpl() {
        return this.holder;
    }
    ...
    public static final Object m1676plusFjFbRPM(Object arg0, E element) {
        if (DebugKt.getASSERTIONS_ENABLED() && (element instanceof List)) {
            throw new AssertionError();
        } else if (arg0 == null) {
            return m1670constructorimpl(element);
        } else {
    ...
    public static final void m1674forEachReversedimpl(Object arg0, Function1<? super E, Unit> action) {
        if (arg0 != null) {
            if (!(arg0 instanceof ArrayList)) {
                action.invoke(arg0);
                return;
