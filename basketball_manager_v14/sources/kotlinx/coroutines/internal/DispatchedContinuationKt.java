...
public final class DispatchedContinuationKt {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:46:0x00f7, code lost:
        if (r17.clearThreadContext() != false) goto L_0x00f9;
     */
    /* JADX WARNING: Removed duplicated region for block: B:24:0x00b3  */
    /* JADX WARNING: Removed duplicated region for block: B:60:0x0118 A[Catch:{ all -> 0x00fe, all -> 0x0128 }] */
    ...
    public static final <T> void resumeCancellableWith(kotlin.coroutines.Continuation<? super T> r22, java.lang.Object r23, kotlin.jvm.functions.Function1<? super java.lang.Throwable, kotlin.Unit> r24) {
        /*
            ...
            r3 = 0
            java.lang.Object r4 = kotlinx.coroutines.CompletionStateKt.toState((java.lang.Object) r23, (kotlin.jvm.functions.Function1<? super java.lang.Throwable, kotlin.Unit>) r24)
        ...
        L_0x0060:
            ...
            r0 = r2
            r14 = 0
            kotlin.coroutines.CoroutineContext r15 = r0.getContext()     // Catch:{ all -> 0x012a }
            kotlinx.coroutines.Job$Key r16 = kotlinx.coroutines.Job.Key     // Catch:{ all -> 0x012a }
            r5 = r16
            kotlin.coroutines.CoroutineContext$Key r5 = (kotlin.coroutines.CoroutineContext.Key) r5     // Catch:{ all -> 0x012a }
            kotlin.coroutines.CoroutineContext$Element r5 = r15.get(r5)     // Catch:{ all -> 0x012a }
            kotlinx.coroutines.Job r5 = (kotlinx.coroutines.Job) r5     // Catch:{ all -> 0x012a }
            ...
            r17 = r0
            java.lang.Object r0 = kotlin.Result.m101constructorimpl(r16)     // Catch:{ all -> 0x00a5 }
        ...
        L_0x00b1:
            ...
            r1 = r2
            r5 = 0
            kotlin.coroutines.Continuation<T> r0 = r1.continuation     // Catch:{ all -> 0x012a }
            java.lang.Object r14 = r1.countOrElement     // Catch:{ all -> 0x012a }
            r15 = r0
            r16 = 0
            kotlin.coroutines.CoroutineContext r0 = r15.getContext()     // Catch:{ all -> 0x012a }
            r17 = r0
            r18 = r2
            r2 = r17
            java.lang.Object r0 = kotlinx.coroutines.internal.ThreadContextKt.updateThreadContext(r2, r14)     // Catch:{ all -> 0x0112 }
            r17 = r0
            kotlinx.coroutines.internal.Symbol r0 = kotlinx.coroutines.internal.ThreadContextKt.NO_THREAD_ELEMENTS     // Catch:{ all -> 0x0112 }
            r19 = r3
            r3 = r17
            if (r3 == r0) goto L_0x00dd
            kotlinx.coroutines.UndispatchedCoroutine r0 = kotlinx.coroutines.CoroutineContextKt.updateUndispatchedCompletion(r15, r2, r3)     // Catch:{ all -> 0x00d9 }
            goto L_0x00de
        L_0x00d9:
            r0 = move-exception
            r1 = r23
        ...
        L_0x00de:
            ...
            r0 = 0
            r20 = r0
            kotlin.coroutines.Continuation<T> r0 = r1.continuation     // Catch:{ all -> 0x0100 }
            r21 = r1
            r1 = r23
            r0.resumeWith(r1)     // Catch:{ all -> 0x00fe }
            kotlin.Unit r0 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x00fe }
            if (r17 == 0) goto L_0x00f9
            boolean r0 = r17.clearThreadContext()     // Catch:{ all -> 0x0128 }
            if (r0 == 0) goto L_0x00fc
        L_0x00f9:
            kotlinx.coroutines.internal.ThreadContextKt.restoreThreadContext(r2, r3)     // Catch:{ all -> 0x0128 }
        L_0x00fc:
            goto L_0x011e
        L_0x00fe:
            r0 = move-exception
        ...
        L_0x0105:
            ...
            boolean r20 = r17.clearThreadContext()     // Catch:{ all -> 0x0128 }
        ...
        L_0x011e:
        L_0x0120:
            boolean r0 = r10.processUnconfinedEvent()     // Catch:{ all -> 0x0128 }
        ...
        L_0x0131:
            r2 = 0
            r11.handleFatalException$kotlinx_coroutines_core(r0, r2)     // Catch:{ all -> 0x013f }
        L_0x0135:
            r2 = 1
