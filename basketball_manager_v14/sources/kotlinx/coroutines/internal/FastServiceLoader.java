...
public final class FastServiceLoader {
    ...
    public final List<MainDispatcherFactory> loadMainDispatcherFactory$kotlinx_coroutines_core() {
        ...
        try {
            ...
            try {
                $this$loadMainDispatcherFactory_u24lambda_u240 = clz.cast(Class.forName("kotlinx.coroutines.android.AndroidDispatcherFactory", true, clz.getClassLoader()).getDeclaredConstructor(new Class[0]).newInstance(new Object[0]));
            ...
            try {
                $this$loadMainDispatcherFactory_u24lambda_u241 = clz.cast(Class.forName("kotlinx.coroutines.test.internal.TestMainDispatcherFactory", true, clz.getClassLoader()).getDeclaredConstructor(new Class[0]).newInstance(new Object[0]));
