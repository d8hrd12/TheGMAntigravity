...
public final class ConcurrentWeakMap<K, V> extends AbstractMutableMap<K, V> {
    ...
    private final class Core {
        ...
        private final void removeCleanedAt(int index) {
            ...
            } while (!ChannelSegment$$ExternalSyntheticBackportWithForwarding0.m(getValues(), index, oldValue, (Object) null));
            ...
            while (true) {
                ...
                if (w == null) {
                    if (value != null) {
                        ...
                        if (ChannelSegment$$ExternalSyntheticBackportWithForwarding0.m(getKeys(), index, (Object) null, hashedWeakRef)) {
                ...
                while (true) {
                    ...
                    while (true) {
                        ...
                        if (!(value instanceof Marked)) {
                            if (ChannelSegment$$ExternalSyntheticBackportWithForwarding0.m(getValues(), index, value, ConcurrentWeakMapKt.mark(value))) {
                                break;
                            }
                        } else {
