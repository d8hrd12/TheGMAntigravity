...
public final class BroadcastChannelImpl<E> extends BufferedChannel<E> implements BroadcastChannel<E> {
        ...
        try {
            ...
            if (!isClosedForSend() || this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                if (this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                    s.m1620trySendJP2dKIU(getValue());
                }
    ...
    public java.lang.Object send(E r10, kotlin.coroutines.Continuation<? super kotlin.Unit> r11) {
        ...
        L_0x0040:
            ...
            r5.lock()
            r3 = 0
            boolean r6 = r2.isClosedForSend()     // Catch:{ all -> 0x00b2 }
            if (r6 != 0) goto L_0x00ad
            int r6 = r2.capacity     // Catch:{ all -> 0x00b2 }
            r7 = -1
            if (r6 != r7) goto L_0x005b
            r2.lastConflatedElement = r10     // Catch:{ all -> 0x00b2 }
        L_0x005b:
            java.util.List<? extends kotlinx.coroutines.channels.BufferedChannel<E>> r6 = r2.subscribers     // Catch:{ all -> 0x00b2 }
            r5.unlock()
            r3 = r6
        ...
        L_0x00a9:
            ...
            return r10
        L_0x00ad:
            java.lang.Throwable r1 = r2.getSendException()     // Catch:{ all -> 0x00b2 }
    ...
    public Object m1613trySendJP2dKIU(E element) {
        Lock lock2 = this.lock;
        lock2.lock();
        try {
            if (isClosedForSend()) {
                return super.m1620trySendJP2dKIU(element);
            }
            ...
            if (shouldSuspend) {
                Object r4 = ChannelResult.Companion.m1643failurePtdJZtk();
                lock2.unlock();
                return r4;
            }
            if (this.capacity == -1) {
            ...
            for (BufferedChannel it2 : this.subscribers) {
                it2.m1620trySendJP2dKIU(element);
            }
            Object r42 = ChannelResult.Companion.m1644successJP2dKIU(Unit.INSTANCE);
            lock2.unlock();
            return r42;
        } finally {
            lock2.unlock();
