...
final class ChannelsKt__DeprecatedKt$map$1 extends SuspendLambda implements Function2<ProducerScope<? super R>, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:28:0x00c8, code lost:
        if (((java.lang.Boolean) r3).booleanValue() == false) goto L_0x010a;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:34:0x00fa, code lost:
        if (r8.send(r3, r2) != r0) goto L_0x00fd;
     */
    ...
    public final java.lang.Object invokeSuspend(java.lang.Object r18) {
        ...
        L_0x008a:
            ...
            r8 = r10
            r11 = 0
            kotlinx.coroutines.channels.ChannelIterator r12 = r8.iterator()     // Catch:{ all -> 0x011c }
            r8 = r6
            r6 = r11
        L_0x00a7:
            r2.L$0 = r4     // Catch:{ all -> 0x011c }
            r2.L$1 = r8     // Catch:{ all -> 0x011c }
            r2.L$2 = r10     // Catch:{ all -> 0x011c }
            r2.L$3 = r12     // Catch:{ all -> 0x011c }
            r11 = 1
            r2.label = r11     // Catch:{ all -> 0x011c }
            java.lang.Object r11 = r12.hasNext(r2)     // Catch:{ all -> 0x011c }
            if (r11 != r0) goto L_0x00b9
            return r0
        L_0x00b9:
            r16 = r4
            ...
            r8 = r16
        L_0x00c2:
            java.lang.Boolean r3 = (java.lang.Boolean) r3     // Catch:{ all -> 0x0116 }
            boolean r3 = r3.booleanValue()     // Catch:{ all -> 0x0116 }
            if (r3 == 0) goto L_0x010a
            java.lang.Object r3 = r12.next()     // Catch:{ all -> 0x0116 }
            r13 = 0
            r2.L$0 = r8     // Catch:{ all -> 0x0116 }
            r2.L$1 = r9     // Catch:{ all -> 0x0116 }
            r2.L$2 = r11     // Catch:{ all -> 0x0116 }
            r2.L$3 = r12     // Catch:{ all -> 0x0116 }
            r2.L$4 = r8     // Catch:{ all -> 0x0116 }
            r14 = 2
            r2.label = r14     // Catch:{ all -> 0x0116 }
            java.lang.Object r14 = r9.invoke(r3, r2)     // Catch:{ all -> 0x0116 }
            if (r14 != r0) goto L_0x00e3
            return r0
        L_0x00e3:
            r3 = r12
            ...
            r14 = r8
        L_0x00e8:
            r2.L$0 = r14     // Catch:{ all -> 0x0116 }
            r2.L$1 = r12     // Catch:{ all -> 0x0116 }
            r2.L$2 = r11     // Catch:{ all -> 0x0116 }
            r2.L$3 = r9     // Catch:{ all -> 0x0116 }
            r15 = 0
            r2.L$4 = r15     // Catch:{ all -> 0x0116 }
            r15 = 3
            r2.label = r15     // Catch:{ all -> 0x0116 }
            java.lang.Object r3 = r8.send(r3, r2)     // Catch:{ all -> 0x0116 }
        ...
        L_0x0106:
            ...
            goto L_0x00a7
        L_0x010a:
            kotlin.Unit r0 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0116 }
            kotlinx.coroutines.channels.ChannelsKt.cancelConsumed(r11, r10)
