...
public final class ProduceKt {
    ...
    public static final java.lang.Object awaitClose(kotlinx.coroutines.channels.ProducerScope<?> r9, kotlin.jvm.functions.Function0 r10, kotlin.coroutines.Continuation<? super kotlin.Unit> r11) {
        ...
        L_0x0050:
            ...
            r5 = 0
            kotlinx.coroutines.CancellableContinuationImpl r6 = new kotlinx.coroutines.CancellableContinuationImpl     // Catch:{ all -> 0x0039 }
            kotlin.coroutines.Continuation r7 = kotlin.coroutines.intrinsics.IntrinsicsKt.intercepted(r4)     // Catch:{ all -> 0x0039 }
            r6.<init>(r7, r3)     // Catch:{ all -> 0x0039 }
            r6.initCancellability()     // Catch:{ all -> 0x0039 }
            r3 = r6
            kotlinx.coroutines.CancellableContinuation r3 = (kotlinx.coroutines.CancellableContinuation) r3     // Catch:{ all -> 0x0039 }
            r7 = 0
            kotlinx.coroutines.channels.ProduceKt$awaitClose$4$1 r8 = new kotlinx.coroutines.channels.ProduceKt$awaitClose$4$1     // Catch:{ all -> 0x0039 }
            r8.<init>(r3)     // Catch:{ all -> 0x0039 }
            kotlin.jvm.functions.Function1 r8 = (kotlin.jvm.functions.Function1) r8     // Catch:{ all -> 0x0039 }
            r9.invokeOnClose(r8)     // Catch:{ all -> 0x0039 }
            java.lang.Object r9 = r6.getResult()     // Catch:{ all -> 0x0039 }
            java.lang.Object r3 = kotlin.coroutines.intrinsics.IntrinsicsKt.getCOROUTINE_SUSPENDED()     // Catch:{ all -> 0x0039 }
            if (r9 != r3) goto L_0x008a
            r3 = r0
            kotlin.coroutines.Continuation r3 = (kotlin.coroutines.Continuation) r3     // Catch:{ all -> 0x0039 }
            kotlin.coroutines.jvm.internal.DebugProbesKt.probeCoroutineSuspended(r3)     // Catch:{ all -> 0x0039 }
        L_0x008a:
    ...
    public static /* synthetic */ ReceiveChannel produce$default(CoroutineScope coroutineScope, CoroutineContext coroutineContext, int i, CoroutineStart coroutineStart, Function1 function1, Function2 function2, int i2, Object obj) {
        ...
        return produce(coroutineScope, coroutineContext, i, coroutineStart, function12, function2);
    }
