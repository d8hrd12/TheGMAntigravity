...
final class BufferedChannel$onUndeliveredElementReceiveCancellationConstructor$1$1 extends Lambda implements Function3<SelectInstance<?>, Object, Object, Function1<? super Throwable, ? extends Unit>> {
    ...
    public final Function1<Throwable, Unit> invoke(final SelectInstance<?> select, Object obj, final Object element) {
        ...
        return new Function1<Throwable, Unit>() {
            ...
            public final void invoke(Throwable it) {
                if (element != BufferedChannelKt.getCHANNEL_CLOSED()) {
                    OnUndeliveredElementKt.callUndeliveredElement(bufferedChannel.onUndeliveredElement, element, select.getContext());
                }
            }
        };
    }
