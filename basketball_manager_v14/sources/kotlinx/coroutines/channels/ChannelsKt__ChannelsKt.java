...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    public static final <E> Object trySendBlocking(SendChannel<? super E> $this$trySendBlocking, E element) {
        Object $this$onSuccess_u2dWpGqRn0$iv = $this$trySendBlocking.m1652trySendJP2dKIU(element);
        if ($this$onSuccess_u2dWpGqRn0$iv instanceof ChannelResult.Failed) {
            return ((ChannelResult) BuildersKt__BuildersKt.runBlocking$default((CoroutineContext) null, new ChannelsKt__ChannelsKt$trySendBlocking$2($this$trySendBlocking, element, (Continuation<? super ChannelsKt__ChannelsKt$trySendBlocking$2>) null), 1, (Object) null)).m1641unboximpl();
        }
    ...
    public static final /* synthetic */ void sendBlocking(SendChannel $this$sendBlocking, Object element) {
        if (!ChannelResult.m1639isSuccessimpl($this$sendBlocking.m1652trySendJP2dKIU(element))) {
