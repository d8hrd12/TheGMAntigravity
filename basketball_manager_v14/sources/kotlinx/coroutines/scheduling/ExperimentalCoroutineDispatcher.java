...
public class ExperimentalCoroutineDispatcher extends ExecutorCoroutineDispatcher {
    ...
    public void dispatch(CoroutineContext context, Runnable block) {
        ...
        try {
            block2 = block;
            try {
                CoroutineScheduler.dispatch$default(this.coroutineScheduler, block2, (TaskContext) null, false, 6, (Object) null);
            } catch (RejectedExecutionException e) {
                RejectedExecutionException rejectedExecutionException = e;
            }
        } catch (RejectedExecutionException e2) {
            block2 = block;
            RejectedExecutionException rejectedExecutionException2 = e2;
            DefaultExecutor.INSTANCE.dispatch(context, block2);
        }
    }
    ...
    public void dispatchYield(CoroutineContext context, Runnable block) {
        ...
        try {
            block2 = block;
            try {
                CoroutineScheduler.dispatch$default(this.coroutineScheduler, block2, (TaskContext) null, true, 2, (Object) null);
            } catch (RejectedExecutionException e) {
                RejectedExecutionException rejectedExecutionException = e;
            }
        } catch (RejectedExecutionException e2) {
