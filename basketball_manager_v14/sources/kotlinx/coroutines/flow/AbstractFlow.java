...
public abstract class AbstractFlow<T> implements Flow<T>, CancellableFlow<T> {
    ...
    public final java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super T> r6, kotlin.coroutines.Continuation<? super kotlin.Unit> r7) {
        ...
        L_0x002c:
            ...
            kotlin.ResultKt.throwOnFailure(r7)     // Catch:{ all -> 0x0059 }
            goto L_0x0052
        L_0x0034:
            ...
            r6 = r3
            r3 = r6
            kotlinx.coroutines.flow.FlowCollector r3 = (kotlinx.coroutines.flow.FlowCollector) r3     // Catch:{ all -> 0x0059 }
            r0.L$0 = r6     // Catch:{ all -> 0x0059 }
            r4 = 1
            r0.label = r4     // Catch:{ all -> 0x0059 }
            java.lang.Object r3 = r2.collectSafely(r3, r0)     // Catch:{ all -> 0x0059 }
