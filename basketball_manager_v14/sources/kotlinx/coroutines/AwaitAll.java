...
final class AwaitAll<T> {
    ...
    public final Object await(Continuation<? super List<? extends T>> $completion) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            $this$await_u24lambda_u242_u24lambda_u240.setHandle(JobKt__JobKt.invokeOnCompletion$default(deferred, false, false, $this$await_u24lambda_u242_u24lambda_u240, 3, (Object) null));
            Unit unit = Unit.INSTANCE;
            nodes[i] = awaitAllNode;
        }
    ...
    private final class AwaitAllNode extends JobNode {
        ...
        public void invoke(Throwable cause) {
            if (cause != null) {
                ...
                continuation2.resumeWith(Result.m101constructorimpl((List) destination$iv$iv));
            }
        }
    }
}
