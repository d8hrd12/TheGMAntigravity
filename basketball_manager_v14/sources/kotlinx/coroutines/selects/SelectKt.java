...
public final class SelectKt {
    ...
    public static final <R> Object select(Function1<? super SelectBuilder<? super R>, Unit> builder, Continuation<? super R> $completion) {
        SelectImplementation $this$select_u24lambda_u241 = new SelectImplementation($completion.getContext());
    ...
    /* access modifiers changed from: private */
    public static final boolean tryResume(CancellableContinuation<? super Unit> $this$tryResume, Function1<? super Throwable, Unit> onCancellation) {
