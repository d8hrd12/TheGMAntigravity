    ...
    public String promptOnJsPrompt(String origin, String message, String defaultValue) {
        ...
        if (defaultValue == null || !defaultValue.startsWith("gap:")) {
            ...
            if (defaultValue != null && defaultValue.startsWith("gap_bridge_mode:")) {
                try {
                    jsSetNativeToJsBridgeMode(Integer.parseInt(defaultValue.substring(16)), Integer.parseInt(message2));
                ...
                try {
                    String r = jsRetrieveJsMessages(Integer.parseInt(defaultValue.substring(9)), "1".equals(message2));
                    if (r == null) {
                        return "";
                    }
                    return r;
            ...
            try {
                ...
                try {
                    String r2 = jsExec(array.getInt(0), array.getString(1), array.getString(2), array.getString(3), message);
                    if (r2 == null) {
                        return "";
                    }
                    return r2;
