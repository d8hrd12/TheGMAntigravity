...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    private UIntProgression(int start, int endInclusive, int step2) {
        if (step2 == 0) {
            ...
            this.first = start;
            this.last = UProgressionUtilKt.m1306getProgressionLastElementNkh28Cs(start, endInclusive, step2);
            this.step = step2;
        } else {
    ...
    public final int m1320getFirstpVg5ArA() {
        return this.first;
    }

    /* renamed from: getLast-pVg5ArA  reason: not valid java name */
    public final int m1321getLastpVg5ArA() {
        return this.last;
    }
    ...
    public String toString() {
        ...
        StringBuilder sb;
        if (this.step > 0) {
            sb = new StringBuilder().append(UInt.m242toStringimpl(this.first)).append("..").append(UInt.m242toStringimpl(this.last)).append(" step ");
            i = this.step;
        } else {
            sb = new StringBuilder().append(UInt.m242toStringimpl(this.first)).append(" downTo ").append(UInt.m242toStringimpl(this.last)).append(" step ");
            i = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final UIntProgression m1322fromClosedRangeNkh28Cs(int rangeStart, int rangeEnd, int step) {
