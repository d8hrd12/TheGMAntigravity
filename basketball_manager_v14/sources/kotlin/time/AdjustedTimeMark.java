...
final class AdjustedTimeMark implements TimeMark {
    ...
    public final long m1422getAdjustmentUwyO8pc() {
    ...
    public TimeMark m1423minusLRDsOJo(long duration) {
        return TimeMark.DefaultImpls.m1573minusLRDsOJo(this, duration);
    }

    /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
    public long m1421elapsedNowUwyO8pc() {
        return Duration.m1468minusLRDsOJo(this.mark.m1570elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1424plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1469plusLRDsOJo(this.adjustment, duration), (DefaultConstructorMarker) null);
    }
}
