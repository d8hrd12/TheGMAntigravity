...
public final class LongSaturatedMathKt {
    ...
    public static final long m1562saturatingAddNuflL3o(long value, DurationUnit unit, long duration) {
        DurationUnit durationUnit = unit;
        Intrinsics.checkNotNullParameter(durationUnit, "unit");
        long j = duration;
        long durationInUnit = Duration.m1479toLongimpl(j, durationUnit);
        boolean z = true;
        if (((value - 1) | 1) == Long.MAX_VALUE) {
            return m1561checkInfiniteSumDefinedPjuGub4(value, j, durationInUnit);
        }
        if (((durationInUnit - 1) | 1) != Long.MAX_VALUE) {
            z = false;
        }
        if (z) {
            return m1563saturatingAddInHalvesNuflL3o(value, unit, duration);
        }
    ...
    private static final long m1561checkInfiniteSumDefinedPjuGub4(long value, long duration, long durationInUnit) {
        if (!Duration.m1465isInfiniteimpl(duration) || (value ^ durationInUnit) >= 0) {
            return value;
        }
    ...
    private static final long m1563saturatingAddInHalvesNuflL3o(long value, DurationUnit unit, long duration) {
        long half = Duration.m1436divUwyO8pc(duration, 2);
        long halfInUnit = Duration.m1479toLongimpl(half, unit);
        if ((1 | (halfInUnit - 1)) == Long.MAX_VALUE) {
            return halfInUnit;
        }
        return m1562saturatingAddNuflL3o(m1562saturatingAddNuflL3o(value, unit, half), unit, Duration.m1468minusLRDsOJo(duration, half));
    }

    private static final long infinityOfSign(long value) {
        return value < 0 ? Duration.Companion.m1535getNEG_INFINITEUwyO8pc$kotlin_stdlib() : Duration.Companion.m1534getINFINITEUwyO8pc();
    }

    public static final long saturatingDiff(long valueNs, long origin, DurationUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        if ((1 | (origin - 1)) == Long.MAX_VALUE) {
            return Duration.m1486unaryMinusUwyO8pc(infinityOfSign(origin));
        }
    ...
    public static final long saturatingOriginsDiff(long origin1, long origin2, DurationUnit unit) {
        ...
        if ((((origin2 - 1) | 1) == Long.MAX_VALUE ? 1 : 0) == 0) {
            ...
            return Duration.m1486unaryMinusUwyO8pc(infinityOfSign(origin2));
        }
    }
    ...
    private static final long saturatingFiniteDiff(long value1, long value2, DurationUnit unit) {
        ...
        if (durationUnit.compareTo(DurationUnit.MILLISECONDS) >= 0) {
            return Duration.m1486unaryMinusUwyO8pc(infinityOfSign(result));
        }
        ...
        return Duration.m1469plusLRDsOJo(DurationKt.toDuration(resultMs, DurationUnit.MILLISECONDS), DurationKt.toDuration(resultUnit, durationUnit));
    }
