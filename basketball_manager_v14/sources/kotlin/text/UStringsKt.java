...
public final class UStringsKt {
    ...
    public static final String m1406toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m1408toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m1407toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
        return UnsignedKt.ulongToString(((long) $this$toString_u2dV7xB4Y4) & 4294967295L, CharsKt.checkRadix(radix));
    }

    /* renamed from: toString-JSWoG40  reason: not valid java name */
    public static final String m1405toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final short toUShort(String $this$toUShort) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m432unboximpl();
        }
    ...
    public static final int toUInt(String $this$toUInt) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m248unboximpl();
        }
    ...
    public static final long toULong(String $this$toULong) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m327unboximpl();
        }
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        int r0 = uIntOrNull.m248unboximpl();
        if (Integer.compare(r0 ^ Integer.MIN_VALUE, UInt.m196constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m113boximpl(UByte.m119constructorimpl((byte) r0));
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int r0 = uIntOrNull.m248unboximpl();
        if (Integer.compare(r0 ^ Integer.MIN_VALUE, UInt.m196constructorimpl(SupportMenu.USER_MASK) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m376boximpl(UShort.m382constructorimpl((short) r0));
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m275constructorimpl((long) i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            long result2 = ULong.m275constructorimpl(result * uradix);
            long beforeAdding = result2;
            result = ULong.m275constructorimpl(ULong.m275constructorimpl(((long) UInt.m196constructorimpl(digit)) & 4294967295L) + result2);
        ...
        return ULong.m269boximpl(result);
    }
}
