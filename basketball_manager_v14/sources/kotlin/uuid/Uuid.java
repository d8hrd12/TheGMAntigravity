...
public final class Uuid implements Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m269boximpl(ULong.m275constructorimpl(getMostSignificantBits())), ULong.m269boximpl(ULong.m275constructorimpl(getLeastSignificantBits())));
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m1605fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
    ...
    public static final int LEXICAL_ORDER$lambda$2(Uuid a, Uuid b) {
        if (a.mostSignificantBits != b.mostSignificantBits) {
            return Long.compare(ULong.m275constructorimpl(a.mostSignificantBits) ^ Long.MIN_VALUE, ULong.m275constructorimpl(b.mostSignificantBits) ^ Long.MIN_VALUE);
        }
        return Long.compare(ULong.m275constructorimpl(a.leastSignificantBits) ^ Long.MIN_VALUE, ULong.m275constructorimpl(b.leastSignificantBits) ^ Long.MIN_VALUE);
    }
}
